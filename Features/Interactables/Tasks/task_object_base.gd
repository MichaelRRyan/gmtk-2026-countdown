...
func check_is_interactable(player: Player) -> Array:
	...
	var pre_requisites_met = player.holdable_item_manager.held_item and required_item_type == player.holdable_item_manager.held_item.item_type
	var item_is_missing = has_pre_requisites and !pre_requisites_met and not is_task_complete
